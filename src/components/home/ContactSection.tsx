...
export function ContactSection({ content }: ContactSectionProps) {
  ...
  const whatsAppHref = buildWhatsAppUrl(
    locale === 'es'
      ? 'Hola, quiero información sobre una renta vacacional en Playa del Carmen.'
      : 'Hello! I want information about a vacation rental in Playa del Carmen.',
  )
            ...
            <div className="flex flex-col gap-3">
              ...
              {whatsAppHref && (
                <a
                  ...
                  className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-[#25D366] px-6 text-sm font-semibold text-white transition-opacity hover:opacity-90"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 shrink-0" aria-hidden="true">
